...
\projectinfo{
  ...
  title.cs={Hardwarová realizace numerického integrátoru s metodou vyššího řádu},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
    title.sk={Hardwarová realizace numerického \newline integrátoru s metodou vyššího řádu}, 
